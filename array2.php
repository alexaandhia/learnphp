...
<body>
    <center><h3>Cek Total Harga</h3></center>
    <form method="post" action="">
        <table align="center" border="2" cellspacing="2" cellpadding="5">
            ...
            <tr>
                <td colspan="2"><button name="hitung">Hitung</button></td>
            </tr>
        </table>
    </form>
    <hr>
<?php
    ...
    if (isset($produkdiskon)) {
        if($produkdiskon > 0){
            ...
            echo "<br>";
            echo "<center>"."Harga Produk". $produk . " x ". $total . " = Rp ". number_format($totalharga,2,",",".") ."</center>";
        }    
    }
